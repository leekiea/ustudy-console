...
export class UpdateUserComponent implements OnInit {
	...
	update(event) {
		...
		req.open('POST', 'http://39.107.93.245:8081/dashboard/user/update/' + this.user.id);
	...
	fetch(cb) {
		const req = new XMLHttpRequest();
		req.open('GET', 'http://39.107.93.245:8081/dashboard/user/view/' + this.route.snapshot.params.id);
